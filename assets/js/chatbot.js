...
const FAQDatabase={
    ...
    "hubungi admin":
        ...
        "Silakan klik tombol SMS agar langsung terhubung dengan tim Investment Technology Indonesia."
...
===========================================================
 ...
 assets/js/chatbot.js
 Part 6
 SMS Integration • Contact Actions • External Links
===========================================================
*/
...
function openSMS(
    ...
    SMSEngine.defaultMessage

){

    window.open(

        createSMSURL(message),
...
function sendConversationToSMS(){
...
function  sms Status(){
    ...
    return{
        ...
        messageLength:
            ...
            SMSEngine.defaultMessage.length
